...
const ERROR_JAVA_EXIST = "No Java found, downloading..";
...
const ERROR_ANDROID_EXIST = "No android-platforms found, downloading..";
const ERROR_ENGINE_EXIST = "No analysis engine found, downloading..";
...
const FINISHED = "Finished, check output for more details.";
